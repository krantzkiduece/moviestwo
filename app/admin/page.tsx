  ...
  return (
    <main className="px-6 py-8 max-w-xl">
      ...
      <p className="text-sm text-gray-600 mb-6">
        You’re considered “logged in” when the <code className="px-1 bg-gray-100 rounded">cc_user</code> cookie equals your admin name (we’re using <code className="px-1 bg-gray-100 rounded">admin</code>).
      </p>
